...
const DeliveryCard = ({ order, fullWidth }: Props) => {
  ...
  //   const {
  //     params: { name, userId },
  //   } = useRoute<ModalScreenRouterProp>();
        ...
        <View>
          ...
          <View style={tw("items-start p-5 -mt-3")}>
            <View style={tw("mx-auto")}>
              ...
              <Text style={tw("text-lg text-center text-white font-bold mb-1")}>
                Expected Delivery:{" "}
            ...
            <View style={tw("mx-auto pb-2")}>
              <Text
                style={tw("text-center text-base text-white font-bold mt-5")}
              >
                Address
              </Text>
